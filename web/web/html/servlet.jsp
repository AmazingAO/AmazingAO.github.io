  ...
  <br/>子元素的设置值可以是同一个Servlet的注册名。
   ...
   2).在Servlet映射到的URL中也可以使用*通配符，但是只能有两种固定的格式：
     ...
     <--<!--配置Servlet-->-->
      ...
      <br/>           public void service(ServletRequest servletRequest, ServletResponse servletResponse) throws ServletException, IOException
      <br/>           ServletRequest:封装了请求信息，可以从中获取到任何请求信息。
      <br/>           ServletResponse:封装了响应信息，如果想给用户什么响应，具体可以使用该接口的实现方法。
      <br/>
      <br/>
      <br/>
      <br/>
